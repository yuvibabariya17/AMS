...
VendorServiceModel appointmentSlotModelFromJson(String str) => VendorServiceModel.fromJson(json.decode(str));

String appointmentSlotModelToJson(VendorServiceModel data) => json.encode(data.toJson());
...
class VendorServiceModel {
    ...
    factory VendorServiceModel.fromJson(Map<String, dynamic> json) => VendorServiceModel(
        ...
        data: List<VendorServiceList>.from(json["data"].map((x) => VendorServiceList.fromJson(x))),
...
class VendorServiceList {
    ...
    factory VendorServiceList.fromJson(Map<String, dynamic> json) => VendorServiceList(
        id: json["_id"],
        fees: json["fees"],
