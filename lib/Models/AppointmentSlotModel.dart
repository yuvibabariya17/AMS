...
AppointmentSlotModel appointmentSlotModelFromJson(String str) =>
    AppointmentSlotModel.fromJson(json.decode(str));

String appointmentSlotModelToJson(AppointmentSlotModel data) =>
...
class AppointmentSlotModel {
  ...
  factory AppointmentSlotModel.fromJson(Map<String, dynamic> json) =>
      AppointmentSlotModel(
        ...
        data: List<SlotList>.from(
            json["data"]?.map((x) => SlotList.fromJson(x)) ?? []),
