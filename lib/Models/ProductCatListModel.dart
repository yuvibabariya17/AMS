...
ProductCategoryListModel productCategoryListModelFromJson(String str) =>
    ProductCategoryListModel.fromJson(json.decode(str));

String productCategoryListModelToJson(ProductCategoryListModel data) =>
...
class ListProductCategory {
  ...
  factory ListProductCategory.fromJson(Map<String, dynamic> json) =>
      ListProductCategory(
        id: json["_id"] ?? '',
        name: json["name"] ?? '',
