  ...
  void initState() {
    if (widget.isEdit == true && widget.editPackage != null) {
      ...
      controller.fromDurationCtr.text =
          DateFormat('yyyy-MM-dd').format(widget.editPackage!.durationFrom);
      controller.toDurationCtr.text =
          DateFormat('yyyy-MM-dd').format(widget.editPackage!.durationTo);
                              ...
                              return getReactiveFormField(
                                ...
                                onTap: () async {
                                  ...
                                  if (pickedDate != null &&
                                    ...
                                    setState(() {
                                      controller.selectedEndDate = pickedDate;
                                    });
                                  }
                                  if (pickedDate != null) {
                                    String formattedDate =
