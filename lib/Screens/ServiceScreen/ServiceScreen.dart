...
class _ServiceScreenState extends State<ServiceScreen> {
  ...
  // deleteDialog(){
  //   return Common().commonDeleteDialog(context, "Are you sure want delete the Service",  )
  // }
                      ...
                      GestureDetector(
                        onTap: () {
                          Common().commonDeleteDialog(context, "Service", () {
                            controller.deleteServiceList(context, data.id);
                          });
        ...
        Expanded(
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Text(
                  formatTime(data.oppoxTime.toString()),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                      fontSize: SizerUtil.deviceType == DeviceType.mobile
          ...
          Row(
            ...
            children: [
              ...
              Text(
                formatTime(data.oppoxSettingDuration.toString()),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                    fontSize: SizerUtil.deviceType == DeviceType.mobile
